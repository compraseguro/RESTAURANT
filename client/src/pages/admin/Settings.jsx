          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-950">
              ...
              <p className="mt-2 text-amber-900/90 leading-snug">
                El texto del ticket (precuenta) sale del sitio en la nube (Vercel), no solo del .exe. Si imprimes y el papel sigue como antes pero aquí NO ves la revisión térmica actual (p. ej. <strong>thermal-v17-table-width-no-logo-default</strong>), el navegador usa JS viejo:
